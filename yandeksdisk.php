...
class YDisk
{
            ...
            if ($key == 'items') {
                foreach ($value as $key2 => $value2) {
                    ...
                    foreach ($value2 as $key3 => $value3) {
                        ...
                        if ($key3 == 'size' && ! empty($value5) && ! empty($value2['public_url'])) {
                            $arResult[$value5]['orig'] = $value2['public_url'];
                        }
                    }
                }
            }
    ...
    public function deleteFile($nameFile)
    {
        ...
        header("Location: /yandeksdisk.php");
    }
...
<body>
    ...
    <form enctype="multipart/form-data" method="post" action="">
        <p>Загрузить файл в корневую папку: <input type="file" name="files">
